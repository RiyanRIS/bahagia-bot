...
module.exports.nulis = (args) => {
  return new Promise((resolve, reject) => {
    ...
    if (kertas == 0) {
      ...
      prosesbukkan3(hit, fon, nama, no, kelas, txt).then((res) => resolve(res)).catch((e) => reject(e))
    } else if (kertas == 3) {
      prosesbukkir1(hit, fon, nama, no, kelas, txt).then((res) => resolve(res)).catch((e) => reject(e))
    }
  })
}
...
const prosesbukkan3 = (hit, fon, nama, no, kelas, txt) => {
  return new Promise((resolve, reject) => {
    let pointer, space
...
const prosesbukkir1 = (hit, fon, nama, no, kelas, txt) => {
  return new Promise((resolve, reject) => {
    let pointer, space
